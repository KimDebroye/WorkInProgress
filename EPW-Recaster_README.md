...
- **Example**<br />![Example](https://i.snipboard.io/OhcZVf.jpg)
  - ➥ **Example to be read as**:
    - Must have:
      ...
      - _any combination of_ `Reduce Physical Damage Taken` **AND** `Reduce Physical Damage Taken`<br />**AND** `although not really applicable for these kind of stats: yet any unique stat (GoF, SB, ...) as wild-card` **OR**
